...
```{r}
hist(moneyballTraining$TARGET_WINS)
hist(moneyballTraining$TEAM_BATTING_H)
hist(moneyballTraining$TEAM_BATTING_2B)
hist(moneyballTraining$TEAM_BATTING_3B)

hist(moneyballTraining$TEAM_BATTING_HR)
hist(moneyballTraining$TEAM_BATTING_BB)
hist(moneyballTraining$TEAM_BATTING_HBP)
hist(moneyballTraining$TEAM_BATTING_SO)

hist(moneyballTraining$TEAM_BASERUN_SB)
hist(moneyballTraining$TEAM_BASERUN_CS)
hist(moneyballTraining$TEAM_FIELDING_E)
hist(moneyballTraining$TEAM_FIELDING_DP)

hist(moneyballTraining$TEAM_PITCHING_BB)
hist(moneyballTraining$TEAM_PITCHING_H)
hist(moneyballTraining$TEAM_PITCHING_HR)
hist(moneyballTraining$TEAM_PITCHING_SO)
...
Hey Suman, Can you verify this section is correct. There seems to be some merging issues. I know you cleaned up the merge but looks like it might have been reintroduced.
