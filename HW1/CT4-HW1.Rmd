...
#similarly other independent variables Vs target wins
...
ggplot(meltMoneyBallTraining, aes(factor(variable), value)) + geom_boxplot() + facet_wrap(~variable, scale="free")
```
