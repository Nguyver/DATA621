...
All the predicted values above cuto??? will be 1 
All the predicted values below cuto??? will be 0  
Response values above cuto???(predicted 1) which are 1 in reality will be noted as TP 
Response values above cuto???(predicted 1) which are 0 in reality will be noted as FP 
Response values below cuto???(predicted 0) which are 1 in reality will be noted as FN 
Response values below cuto???(predicted 0) which are 0 in reality will be noted as TN
...
TP=sum(predicted==1 & crime.test$target==1) 
FP=sum(predicted==1 & crime.test$target==0) 
FN=sum(predicted==0 & crime.test$target==1) 
TN=sum(predicted==0 & crime.test$target==0)
