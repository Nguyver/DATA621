...
fullmod.lnr <- lm(TARGET_AMT ~ , data=insurance.training)
...
insurance.prd <- predict(model.step.log,newdata=subset(insurance.evl,select=c(2,4,6,8,9,11,13,14,15,16,17,18,19,21,22,23,24,26)),type='response')
