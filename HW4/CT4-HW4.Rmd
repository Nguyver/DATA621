...
Running the glimpse() function on the dataset reveals that a few variables are of the wrong data type. 
Below is a glimpse of the data. A quick look indicates that chas and target might be classification variables.
