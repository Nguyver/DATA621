...
Convert the date fields like issue date to proper date type, and remove % sign for interest rates and convert those into numeric values.
...
Identify the categorical variables,and prepare dummy variables.
